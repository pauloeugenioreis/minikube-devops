#!/usr/bin/env bash
# dashboard.sh
# Corrige problemas comuns com o Kubernetes Dashboard no macOS

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
source "$SCRIPT_DIR/../utils/common.sh"

log_info "Corrigindo problemas do Dashboard (macOS)..."
...
if lsof -i :15671 >/dev/null; then
    ...
    log_error "Nao foi possivel iniciar o port-forward."
fi
