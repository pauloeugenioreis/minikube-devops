...
$rabbitmqChartPath = Join-Path $projectPaths.Charts.Root "rabbitmq"
$mongodbChartPath = Join-Path $projectPaths.Charts.Root "mongodb"
$redisChartPath = Join-Path $projectPaths.Charts.Root "redis"
